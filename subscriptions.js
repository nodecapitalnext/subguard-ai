// Mock subscription data - simulates web3 subscriptions
const subscriptions = [
...
function resetSubscriptions() { subscriptions.forEach(s => { s.active = true; }); }
...
module.exports = { getSubscriptions, getTotalMonthly, cancelSubscription, resetSubscriptions, updatePolicy, owsPolicy };
